...
- Use `github.com/oschwald/maxminddb-golang/v2/mmdbdata` for manual decoding
  helpers used by custom unmarshalers.
- Custom types can implement `UnmarshalMaxMindDB(d *mmdbdata.Decoder) error`
